  ...
  return (
    <div className="app-container">
      ...
      <div className={`settings-sidebar ${showSettings ? 'open' : ''}`}>
        <h2>Settings Menu</h2>
        <div>
          <input type="checkbox" checked={randomSetting1} onChange={toggleRandomSetting1} />
          <label>Random Setting 1</label>
        </div>
        <div>
          <label>Random Setting 2:</label>
          <select value={randomSetting2} onChange={handleRandomSetting2Change}>
        ...
        <div>
          ...
          <input type="number" value={randomSetting3} onChange={handleRandomSetting3Change} />
        </div>
      </div>
    </div>
  );
